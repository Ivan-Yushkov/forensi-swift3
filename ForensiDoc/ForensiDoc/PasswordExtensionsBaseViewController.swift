...
extension BaseViewController {
    func processEmailLogic(email: String) -> [String] {
    ...
    func processPasswordLogic(password: String, confirmPassword: String) -> [String]{
        var errorMessages = [String]()
    ...
    func hasAnyErrorMessages(errorMessages: [String]) -> Bool {
        var ret: Bool = true
